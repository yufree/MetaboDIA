## This is the coreponding readmetab_DDA function for DIA data
##@param
...
#### Q1: Q1 result from DIA_umpire
#### Q2: Q2 results from DIA_umpire
...
readmetab_DIA <- function(um_out, db, Q1, Q2, cutoff_file, ms1_tol, ms1_ppm,
                        min_spectrum, min_basepeak, min_int, min_noise, mode, ms2_mz_tol,
                        metmatch_FDR, best_hit, intensity_type) {

  PROTON_MASS = 1.007276
  ms2 <- c(read_mgf(Q1,min_spectrum), read_mgf(Q2,min_spectrum))
  ...
  ###lingking ms2 and add ms2 to the structure record unmapped ms2
  with_ms2 <- NULL
